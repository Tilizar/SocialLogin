package com.andrew.social.login.vk

import android.content.Intent
import android.support.v7.app.AppCompatActivity
import com.andrew.social.login.vk.callback.VkRxTokenCallback
import com.andrew.social.login.base.SocialType
import com.andrew.social.login.base.action.SocialLoginAction
import com.andrew.social.login.vk.callback.VkRxRequestCallback
...
class VkLoginActionImpl(activity: AppCompatActivity) : SocialLoginAction(activity) {
    ...
    override fun handleResult(requestCode: Int, resultCode: Int, intent: Intent?) {
        ...
        loginDisposable = tokenCallback.observe()
                ...
                .subscribe({ callback?.onSuccess(SocialType.VK, token, it) }, { callback?.onError(it) })
    }
